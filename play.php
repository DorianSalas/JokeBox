	...
	<body>
		...
		<script type="text/javascript">
			...
			let endfunc=function(){
				...
				if (player.attributes.track.value<listmusicreal.length) {
					playerdiv.innerHTML="<audio id='player' controls autoplay track='"+(player.attributes.track.value++)+"'><source src='music/"+listmusicreal[player.attributes.track.value++]+"' /></audio>"
